"""
Original source can be found here -> https://github.com/migalkin/StarE/blob/master/data_loaders/load.py
"""
import json
...
RAW_DATA_DIR = Path(os.path.join(FILE_DIR, "..", "..", 'data/raw_data/'))
