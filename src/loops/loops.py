            ...
            with torch.no_grad():
                ...
                if run_trn_testbench:
                    ...
                    print("Epoch: %(epo)03d | Loss: %(loss).5f | Tr_c: %(tracc)0.5f | "
                          ...
                          % {'epo': e,
                             ...
                             'time': timer.interval / 60.0}, flush=True)


                else:
                    # Don't benchmark over train only valid
                ...
                if savedir is not None:
                    mt_save(
                        ...
                        pickle_stuff=[tosave(fname='traces.pkl', obj=[train_loss, valid_acc, valid_mrr, valid_hits_3, valid_hits_5, valid_hits_10])],
